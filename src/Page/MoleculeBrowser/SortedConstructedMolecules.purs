module Page.MoleculeBrowser.SortedConstructedMolecules
    ( Model
    , Action
    , Payload
    , reducer
...
init :: Config.SortedConstructedMolecules -> Model
init config = config
...
_onSetUnsorted actionCreators model dispatch = do
    ...
    pure (unsafePerformEffect
        (runEffectFn1
            dispatch
            (actionCreators.initUnsortedConstructedMolecules payload)
        )
    )
...
_buildingBlockRequest actionCreators model molecule dispatch = do
    ...
    let
        ...
        payload =
            ...
            , history: []
            , molecule: Molecule.key molecule
            , moleculeBrowser: Config.SortedConstructedMolecules model
            , twoDViewer: model.twoDViewer
            , threeDViewer: model.threeDViewer
            }
